...
## Extended Providers — New Pattern Support

These providers support extended fraud patterns (008-017).

### Blockchain Analytics — Chainalysis / Elliptic

**For:** PATTERN-009 (Crypto Mixer/Tumbler Laundering)

**Signal mapping:**

| Signal | Risk Score Contribution |
|--------|-------------------|
| Category = "mixer" | +50 |
| Category = "darknet" | +45 |
| Category = "gambling" | +25 |
| Volume spike 10x in 24h | +20 |
| Associated with flagged entity | +40 |

---

### SIM Swap Detection — Tyneside / Microvisor

**For:** PATTERN-010 (SIM Swap / Number Porting)
...
### Deepfake Detection — Reality Defender / Intel FakeCatcher

**For:** PATTERN-008 (Social Engineering Deepfake)

**Signal mapping:**

| Signal | Risk Score Contribution |
|--------|-------------------|
| is_real_score < 0.3 | +45 |
| is_real_score 0.3-0.6 | +25 |
| fake_probability > 0.8 | +40 |
| Artifact detected | +30 |

---

### Synthetic Identity — LexisNexis / Alloy

**For:** PATTERN-011 (Synthetic Identity)

**Signal mapping:**

| Signal | Risk Score Contribution |
|--------|-------------------|
| SSN/Address mismatch | +40 |
| Multiple applications with same SSN fragment | +35 |
| Address change velocity >3/year | +15 |
| Device fingerprint cluster | +25 |

---

### Domain/Merchant Risk — WHOIS / ScamDB

**For:** PATTERN-012 (Merchant Fraud)
...
| Domain age 30-90 days | +25 |
| In ScamDB | +50 |
| Multiple chargebacks | +30 |

---

### NLP/Communication Analysis — AWS Comprehend / Google NLP

**For:** PATTERN-014 (Romance Fraud), PATTERN-017 (Family/Friend Impersonation)

**Signal mapping:**

| Signal | Risk Score Contribution |
|--------|-------------------|
| Urgency keywords detected | +20 |
| Emergency scenario detected | +25 |
| Style deviation >30% from baseline | +30 |
| Gift card / crypto request | +35 |

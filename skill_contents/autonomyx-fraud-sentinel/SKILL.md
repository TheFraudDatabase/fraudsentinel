...
| PATTERN-008 | Social Engineering Deepfake | High → Critical |
| PATTERN-009 | Cryptocurrency Mixer/Tumbler Laundering | High → Critical |
| PATTERN-010 | SIM Swap / Number Porting Fraud | Critical |
| PATTERN-011 | Synthetic Identity Fraud | High → Critical |
| PATTERN-012 | Merchant Fraud / Fake Ecommerce | High → Critical |
| PATTERN-013 | Investment Ponzi / Pyramid Scheme | Critical |
| PATTERN-014 | Romance Fraud / Long-Con Scam | High → Critical |
| PATTERN-015 | Invoice Manipulation / Billing Fraud | High → Critical (B2B) |
| PATTERN-016 | Account Takeover Recovery Pattern | High |
| PATTERN-017 | Family/Friend Impersonation (Reactivation) | High → Critical |
